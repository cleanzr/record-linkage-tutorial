...
![](figures/recordLinkage_graphicalModel.pdf){ height=2in }
...
\vspace{-1.5cm}
\begin{itemize}
\item Enumeration of victims of killings in Syria merging four databases.
\vspace{1cm}
\item The number of data points in each cluster should remain small even for large data sets $\rightarrow$ Large number of singletons and small clusters.
\end{itemize}
\end{minipage}
