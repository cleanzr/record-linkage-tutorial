...
![alt text](figures/noblocking_plot.pdf){ width=45% }    
...
- Why? A noisy feature used for determisitic blocking can miss a large proportion of matches (i.e. increased false negatives rates).
