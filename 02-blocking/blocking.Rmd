...
- \textcolor{blue}{Levenshtein (edit) distance (1966)}: minimum number of substitutions required to transform one string into another e.g. A\textcolor{red}{d}a\textcolor{blue}{m} vs A\textcolor{blue}{l}a\textcolor{blue}{n} has a distance $L=2$, normalized as $1-\frac{L}{maxLength} = 0.5$.
...
\begin{tabular}{ l l l l }
 {\color{blue}\emph{A}} & Mary Clain & 123 Oak St & 90210 \\
 {\color{blue}\emph{B}} & Mary Klein & 123 Oak Street & 90210 \\
 {\color{blue}\emph{C}} & Mary Klain & 123 Oak St & 50210 \\
\end{tabular}
\end{center}
